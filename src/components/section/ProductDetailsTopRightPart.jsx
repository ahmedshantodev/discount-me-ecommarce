      ...
      <div>
        <div className="flex items-center gap-x-4">
          <div className="flex items-center gap-x-2.5 2xl:gap-x-5 border-2 border-[#e6e6e6] p-1 2xl:p-[6px] rounded-[40px]">
            <button className="bg-[#f2f2f2] p-2.5 text-black rounded-[40px] text-lg 2xl:text-2xl">
              <FiMinus />
            </button>
          ...
          <button className="bg-[#dfe1e3] p-3 text-black rounded-[40px] text-lg 2xl:text-3xl">
            <CiShoppingCart />
          </button>
        </div>
      </div>
